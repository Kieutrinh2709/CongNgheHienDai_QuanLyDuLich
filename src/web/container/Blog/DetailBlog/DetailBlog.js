            ...
            <div className="breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active" aria-current="page">{tintucs ? tintucs.find(x => x.id === +id).title : ''}</li>
                    </ol>
                </nav>
            </div>
                            ...
                            <div className="col-md-9" key={ok.id}>
                                ...
                                <div className="content">
                                    ...
                                    <div className="text-right">
                                        <p>Ngày đăng: <i><strong>{formatdate(ok.created_date)}</strong></i></p>
                                    </div>
                                    <div>
                            ...
                            {sx.map(ok => (
                                <div className="box-tinhot" key={ok.id}>
                                    ...
                                    <div className="title-new">
                                        <p className="mb-2"><Link to={`/detail-new/${ok.id}`} className="title-new-hot">{ok.title}</Link></p>
                                        <span><i className="far fa-clock"></i> {formatdate(ok.created_date)}</span>
                                    </div>
                                </div>
                            ))}
                        </div>
