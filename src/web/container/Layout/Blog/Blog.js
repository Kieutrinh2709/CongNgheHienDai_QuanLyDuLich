  ...
  return (
    <div id="news" >
      <div className="heading text-center">
        ...
        <hr  width="40%" height ="50%" align="center" />
      </div>
            ...
            <div className="col-sm-6 mb-3" key={ok.id}>
              <Linkrt to={`/detail-new/${ok.id}`}>
                <div className="news-box">
                  <img src={ok.image} width="540px" height="303px" alt="" />
              ...
              <Linkrt to={`/detail-new/${ok.id}`}>
                <div className="news-box">
                  <div style={{ height: "190px" }}>
                    <img src={ok.image} className="w-100 h-100" alt="" />
                  </div>
                ...
                <div className="col-md-12" key={ok.id}>
                  <Linkrt to={`/detail-new/${ok.id}`}>
                    <div className="news-box">
                      <div className="row">
                        <div className="col-4">
                          <img src={ok.image} className="" alt="" />
                        </div>
                        <div className="col-8">
                          <strong style={{ fontSize: ".9rem" }}>{ok.title}</strong>
                        </div>
                      </div>
                    </div>
                  </Linkrt>
      ...
      <div className="xem-them">
        <Linkrt to="/listblog">Xem Thêm &gt;&gt;</Linkrt>
      </div>
    </div>
